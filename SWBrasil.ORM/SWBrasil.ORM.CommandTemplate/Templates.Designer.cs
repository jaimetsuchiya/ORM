...
")]
        ...
        [global::System.Configuration.DefaultSettingValueAttribute("using System;\r\nusing System.Collections.Generic;\r\nusing System.Data;\r\nusing Syste" +
            ...
            "{TABLE_NAME}({TABLE_NAME}DTO model)\r\n        {\r\n            OutputTransport<{TAB" +
            "LE_NAME}DTO> ret = new OutputTransport<{TABLE_NAME}DTO>();\r\n\t\t\tret = _{TABLE_NAM" +
            "E}BO.Salvar(new InputTransport<{TABLE_NAME}DTO>() { Data = model, UserName = bas" +
            "e.UserInfo.logon });\r\n\r\n            return Request.CreateResponse<OutputTranspor" +
            "t<{TABLE_NAME}DTO>>(HttpStatusCode.OK, ret);\r\n        }\r\n\r\n\t\t#endregion CRUD\r\n\t}" +
            "\r\n}\r\n")]
